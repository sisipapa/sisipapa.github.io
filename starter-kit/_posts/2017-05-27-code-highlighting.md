---
layout: post title: "A quick demo of Simple Texture theme's code highlighting features"
...
Here is a literal `` ` `` backtick. And here is a Ruby code fragment `x = Class.new`{:.language-ruby}
...
{% highlight c# %} public class Hello { public static void Main() { Console.WriteLine("Lorem ipsum dolor sit amet,
...
proident, sunt in culpa qui officia deserunt mollit anim id est laborum."); } } {% endhighlight %}

## Highlight with line numbers and long lines

{% highlight javascript linenos=table %} function myFunction() { alert("Lorem ipsum dolor sit amet, consectetur
...
culpa qui officia deserunt mollit anim id est laborum."); } {% endhighlight %}
