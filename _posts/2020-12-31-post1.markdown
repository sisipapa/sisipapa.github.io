...
**개인 GCP 클라우드 서버 쿠버네티스 클러스터에 적용한 URL**

```
**Prometheus 서버 :** [http://34.64.209.18:31213/](http://34.64.209.18:31213/)
**Grafana :** [http://34.64.209.18:30837/d/4XuMd2Iiz/kubernetes-cluster-prometheus?orgId=1](http://34.64.209.18:30837/d/4XuMd2Iiz/kubernetes-cluster-prometheus?orgId=1)
```
...
**Prometheus 브라우저 접속확인 [**34.64.249.210:31213, 34.64.209.18:31213 **]**

```bash
$ kubectl get svc -o wide -n monitoring

NAME                 TYPE           CLUSTER-IP     EXTERNAL-IP                  PORT(S)          AGE     SELECTOR
prometheus-service   LoadBalancer   10.99.72.195   34.64.249.210,34.64.209.18   8080:31213/TCP   7d      app=prometheus-server
```
...
Grafana **브라우저 접속확인 [**34.64.249.210:30837, 34.64.209.18:30837 **]**

```bash
$ kubectl get svc -n monitoring
NAME                 TYPE           CLUSTER-IP     EXTERNAL-IP                  PORT(S)          AGE
grafana              LoadBalancer   10.109.82.53   34.64.249.210,34.64.209.18   3000:30837/TCP   6d23h
prometheus-service   LoadBalancer   10.99.72.195   34.64.249.210,34.64.209.18   8080:31213/TCP   7d
```
